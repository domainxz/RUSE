...
public class DateSearch extends SimpleSearch {
	/**
	 * Implements SimpleSearch key word is date string
	 */
	protected int compareTo(int pos, String content){
		return contents[pos].substring(contents[pos].indexOf('|') + 1).compareTo(content);
	}
	/**
